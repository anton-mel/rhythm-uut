...
# ===========================================================================
# Reset — assign to an expansion pin or tie low if not used
# ===========================================================================
# set_property PACKAGE_PIN <pin>   [get_ports reset]
# set_property IOSTANDARD  LVCMOS33 [get_ports reset]

# ===========================================================================
# LVDS SPI — assign P/N pairs below to match your PCB wiring.
# All pairs below are Bank 34 (MC1) or Bank 35 (MC2), 2.5 V capable (LVDS_25).
#
# Available Bank 34 differential pairs (MC1 connector):
...
#
# Available Bank 35 differential pairs (MC2 connector):
...
#
# Example (replace <P_pin>/<N_pin> with actual balls from the lists above):
# ===========================================================================
...
# --- Port B ---
# set_property PACKAGE_PIN <P_pin> [get_ports MISO_B1_p]  ... (same pattern)
# set_property IOSTANDARD LVDS_25 [get_ports {MISO_B1_p MISO_B1_n ...}]

# --- Port C ---
# set_property PACKAGE_PIN <P_pin> [get_ports MISO_C1_p]  ...
# set_property IOSTANDARD LVDS_25 [get_ports {MISO_C1_p MISO_C1_n ...}]

# --- Port D ---
# set_property PACKAGE_PIN <P_pin> [get_ports MISO_D1_p]  ...
# set_property IOSTANDARD LVDS_25 [get_ports {MISO_D1_p MISO_D1_n ...}]

# ===========================================================================
# TTL I/O, DAC SPI, ADC SPI, board_mode — single-ended, LVCMOS33
# Assign any single-ended Bank 34/35 pin from the lists above.
# ===========================================================================
# set_property PACKAGE_PIN <pin> [get_ports {TTL_in[0]}]   ... (16 pins)
# set_property PACKAGE_PIN <pin> [get_ports {TTL_out[0]}]  ... (16 pins)
...
# set_property PACKAGE_PIN <pin> [get_ports DAC_DIN_1]   ... through DAC_DIN_8
# set_property IOSTANDARD LVCMOS33 [get_ports {DAC_SYNC DAC_SCLK DAC_DIN_*}]

# set_property PACKAGE_PIN <pin> [get_ports ADC_CS]
# set_property PACKAGE_PIN <pin> [get_ports ADC_SCLK]
# set_property PACKAGE_PIN <pin> [get_ports ADC_DOUT_1]  ... through ADC_DOUT_8
# set_property IOSTANDARD LVCMOS33 [get_ports {ADC_CS ADC_SCLK ADC_DOUT_*}]

# set_property PACKAGE_PIN <pin> [get_ports {board_mode[0]}]  ... (4 pins)
